...
function parseExtensions(extensions: string | Record<string, unknown> | undefined, code = 'INTERNAL_SERVER_ERROR'): Record<string, unknown> {
...
export async function createErrorResponse(
  error: GraphQLError
): Promise<Response<EZContext, unknown>> {
  const errors = [error];
