...
import type { EnvelopContext } from '@graphql-ez/core';
...
declare module '@graphql-ez/core' {
  interface EnvelopResolvers extends Resolvers<import('@graphql-ez/core').EnvelopContext> {}
}
