              ...
              items={[
                {
                  title: (
                    <IntegrationItemTitle
                      name="Fastify"
                      integrationWebsite="https://fastify.io"
                      logo={<FastifyLogo className={baseLogoStyles} />}
                    />
                  ),
                  description: (
                    <ItemDescription
                ...
                },
                {
                  title: (
                    <IntegrationItemTitle
                      name="Express"
                      integrationWebsite="https://expressjs.com/"
                      logo={<ExpressLogo className={baseLogoStyles} />}
                    />
                  ),
                  description: (
                    <ItemDescription
                ...
                },
                {
                  title: (
                    <IntegrationItemTitle
                      name="Hapi"
                      integrationWebsite="https://hapi.dev/"
                      logo={<HapiLogo className={baseLogoStyles} />}
                    />
                  ),
                  description: (
                    <ItemDescription
                ...
                },
                {
                  title: (
                    <IntegrationItemTitle
                      name="Koa"
                      integrationWebsite="https://koajs.com/"
                      logo={<KoaLogo className={baseLogoStyles} />}
                    />
                  ),
                  description: (
                ...
                },
                {
                  title: (
                    <IntegrationItemTitle
                      ...
                      logo={<NodeLogo className={baseLogoStyles} />}
                    />
                  ),
                ...
                },
                {
                  title: (
                    <IntegrationItemTitle
                      ...
                      logo={<NextjsLogo className={baseLogoStyles} />}
                    />
                  ),
                  description: (
                ...
                },
                {
                  title: (
                    <IntegrationItemTitle
                      ...
                      logo={<CloudflareWorkersLogo className={baseLogoStyles} />}
                    />
                  ),
                  description: (
                    <ItemDescription
                ...
                },
                {
                  title: (
                    <IntegrationItemTitle
                      ...
                      logo={<SvelteKitLogo height="80px" className={baseLogoStyles} />}
                    />
                  ),
                  description: (
                ...
                },
                {
                  title: (
                    <IntegrationItemTitle
                      ...
                      logo={<VercelLogo height="80px" className={baseLogoStyles} />}
                    />
                  ),
                  description: (
