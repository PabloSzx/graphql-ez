...
import TinyhttpLogoImage from '../../public/assets/logos/tinyhttp.png';
...
export const TinyhttpLogo = (props: LogoImageProps) => {
  return <Image src={TinyhttpLogoImage} {...baseLogoStyles} {...props} />;
};
