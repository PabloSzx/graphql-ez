...
you will need to create your endpoint as [Fallthrough Routes](https://kit.svelte.dev/docs#routing-advanced-fallthrough-routes), for example `/src/routes/api/[...any].ts`, otherwise, you can create it as any endpoint you prefer, for example: `/src/routes/api/graphql.ts`.
