...
import type { EnvelopContext } from 'ez-gql/hapi';
...
) => Promise<import('ez-gql/hapi').DeepPartial<TResult>> | import('ez-gql/hapi').DeepPartial<TResult>;
...
declare module 'ez-gql/hapi' {
  interface EnvelopResolvers extends Resolvers<import('ez-gql/hapi').EnvelopContext> {}
}
