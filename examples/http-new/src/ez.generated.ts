...
import type { EZContext } from '@graphql-ez/http-new';
...
) => Promise<import('@graphql-ez/http-new').DeepPartial<TResult>> | import('@graphql-ez/http-new').DeepPartial<TResult>;
...
declare module '@graphql-ez/http-new' {
  interface EZResolvers extends Resolvers<import('@graphql-ez/http-new').EZContext> {}
}
